        ...
        <div class="flex flex-col min-w-full px-4">
            ...
            <div class="side-menu">
                <ul class="flex flex-col items-start p-4 pl-2 text-gray-600 font-semibold capitalize">
                    ...
                    <a href="/dashboard/students" class="rounded-lg w-full py-2">
                    ...
                    <a href="/dashboard/officers" class="rounded-lg w-full py-2">
                    ...
                    <a href="/dashboard/payments" class="rounded-lg w-full py-2">
