...
<body>
    <div class="wrapper w-full">
        <div class="flex justify-between">
            <div class="left-section w-1/2 h-full p-14">
                <div class="back text-blue-600 font-semibold mb-8">
                ...
                <div class="sign-in-text font-medium text-black mb-4 text-3xl">
            ...
            <div class="right-section w-1/2 overflow-hidden">
                <img class="w-full h-full bg-cover" src="https://source.unsplash.com/1920x2000/?webdevelopment" alt="">
            </div>
        </div>
    </div>
